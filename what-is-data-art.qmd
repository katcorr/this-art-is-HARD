...
::: columns
::: {.column width="33%"}
![](images/alex_sketch1.jpeg){fig-alt="A colored pencil sketch drawing colors to particular numbers and creating a colorful crisscross pattern" fig-align="center"}
:::

::: {.column width="34%"}
![](images/alex_sketch2.jpeg){fig-alt="A colored pencil drawing with bars colored green to brown to blue" fig-align="center"}
:::

::: {.column width="33%"}
![](images/alex_sketch3.jpeg){fig-alt="A colored pencil sketch using different colors and patterns to represent ratios" fig-align="center"}
:::
:::
